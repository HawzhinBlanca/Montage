...
class TestDatabaseSetup:
    ...
    def test_foreign_keys(self, db_connection):
        ...
        highlight_fk = next((fk for fk in foreign_keys if fk[0] == 'highlight' and fk[1] == 'job_id'), None)
        assert highlight_fk is not None, "highlight.job_id foreign key not found"
        assert highlight_fk[2] == 'video_job', "highlight.job_id should reference video_job"
