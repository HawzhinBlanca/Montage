...
from transcript_analyzer import analyze_video_content
from smart_crop import apply_smart_crop
from budget_guard import budget_manager, BudgetExceededError, with_budget_tracking
...
class VideoProcessingPipeline:
    ...
    def create_job(self, input_path: str, output_path: str, 
    ...
    def _execute_stages(self, job_id: str, job: Dict, start_stage: str) -> Dict[str, Any]:
        """Execute pipeline stages"""
        stages = ['validation', 'analysis', 'highlights', 'editing', 'encoding', 'finalization']
            ...
            if stage == 'validation':
                ...
                if not edit_plan:
                    ...
                    if checkpoint and checkpoint['stage'] == 'analysis':
                        ...
                        highlights = analyze_video_content(job_id, input_path, input_path)
...
def main():
    ...
    parser.add_argument('--smart-crop', action='store_true', help='Apply smart cropping')
