...
try:
    ...
    from .memory_manager import get_memory_monitor, MemoryPressureLevel, ProcessingMode
    from .resource_manager import managed_process, get_resource_tracker
except ImportError:
    import sys
    ...
    from utils.resource_manager import managed_process, get_resource_tracker
