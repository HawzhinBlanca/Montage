...
class StandalonePerformanceBenchmark:
        ...
        for duration in durations:
            ...
            try:
                ...
                cmd = [
                    ...
                    '-vf', 'crop=get_smart_crop_params()',  # 9:16 crop from 16:9
    ...
    def _benchmark_memory_usage_patterns(self) -> Dict[str, Any]:
        ...
        video_configs = [
            {'duration: get_dynamic_duration()p
            {'duration: get_dynamic_duration(), 1080)},  # 5min 1080p
            {'duration: get_dynamic_duration(), 1080)},  # 10min 1080p
        ]
        results = []
        ...
        scenarios = [
            {
                ...
                'operations': ['crop=get_smart_crop_params()', 'loudnorm=I=-16:TP=-1.5:LRA=7']
            },
            {
