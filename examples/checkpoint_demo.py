...
def simulate_video_processing_with_checkpoints(
    job_id: str, simulate_crash_at: str = None
):
    ...
    db.update(
        "video_job", {"status": "completed", "completed_at": "NOW()"}, {"id": job_id}
    )
...
def generate_stage_results(stage: str) -> dict:
    ...
    results = {
        ...
        "editing": {"cuts_made": 12, "transitions_added": 11, "output_duration": 180.2},
        "audio_normalization": {
            "loudness_lufs": -16.0,
            "peak_db": -1.0,
            "lra": 7.5,
        ...
        "color_correction": {
            "color_space": "bt709",
            "adjustments": {"brightness": 0, "contrast": 1.05, "saturation": 1.02},
        },
        "export": {
...
def main():
    ...
    parser.add_argument(
        "--show-progress", action="store_true", help="Show job progress and exit"
    )
