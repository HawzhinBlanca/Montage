...
class BudgetExceededError(Exception):
    ...
    def __init__(self, message=None, current_cost=0.0, budget_cap=0.0, additional_cost=0.0):
        if message is None:
            message = f"Budget exceeded: ${current_cost:.2f} + ${additional_cost:.2f} > ${budget_cap:.2f}"
