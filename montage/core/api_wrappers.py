...
from .rate_limit_config import env_config, get_service_config
    ...
    def transcribe_large_audio(
        ...
        **options,
        ...
        try:
            ...
            from montage.utils.ffmpeg_utils import get_video_info
...
class OpenAIWrapper(ServiceWrapper):
    ...
    def generate_completion(
        ...
        OPENAI_API_KEY = settings.api_keys.openai.get_secret_value() if settings.api_keys.openai else None
...
class AnthropicWrapper(ServiceWrapper):
    ...
    def generate_highlights(
        ...
        try:
            ...
            from ..settings import settings
            ANTHROPIC_API_KEY = settings.api_keys.anthropic.get_secret_value() if settings.api_keys.anthropic else None
        except ImportError:
...
class APIServiceError(Exception):
    ...
    def __init__(self, message="API service error", service=None, status_code=None):
