...
class VideoValidationError(Exception):
    ...
    def __init__(self, message="Video validation failed", file_path=None):
...
class UnsupportedFormatError(VideoValidationError):
    ...
    def __init__(self, file_path, format_detected=None, supported_formats=None):
        message = f"Unsupported video format: {file_path}"
        if format_detected:
