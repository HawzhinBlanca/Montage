...
try:
    ...
    from .memory_manager import MemoryPressureLevel, get_memory_monitor
except ImportError:
    import sys
    from pathlib import Path

    from montage.utils.logging_config import get_logger
    from montage.utils.memory_manager import MemoryPressureLevel, get_memory_monitor
...
class ResourceTracker:
    ...
    def _opencv_cleanup_callback(self, weak_ref):
        ...
        try:
            ...
            logger.debug("Weak reference already removed from tracked OpenCV objects")
