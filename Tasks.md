Below is a step-by-step, machine-runnable build plan that turns the current synchronous prototype into a truly production-ready, multi-user, fault-tolerant Montage v3.5.
