...
from src.core.metrics import track_processing_stage
...
class ColorSpaceConverter:
    ...
    def analyze_color_space(self, input_file: str) -> ColorSpaceInfo:
        ...
        try:
            ...
            logger.info("Color space analysis:")
    ...
    def build_color_conversion_filter(
        self, source_color_info: Optional[ColorSpaceInfo] = None
    ) -> str:
        """
    ...
    def convert_to_bt709(
        ...
        logger.info("Converting to BT.709 color space...")
        ...
        try:
            ...
            if not result["conversion_successful"]:
                logger.warning(
                    f"Color conversion may have failed. Output primaries: {output_info.color_primaries}"
                )
            else:
    ...
    def build_safe_encoding_command(
        self,
        input_file: str,
        output_file: str,
...
def ensure_bt709_output(
    input_file: str, output_file: str, preserve_filters: Optional[str] = None
) -> Dict[str, Any]:
    """
    ...
    return converter.convert_to_bt709(
        input_file, output_file, additional_filters=preserve_filters
    )
...
class ColorSafeVideoEditor:
    ...
    def edit_with_color_safety(
        self, input_file: str, output_file: str, edit_filters: str = ""
    ) -> Dict[str, Any]:
        ...
        cmd = self.color_converter.build_safe_encoding_command(
            input_file, output_file, video_filters=edit_filters
        )
